    ...
    <>
      <div className="md:hidden">
        ...
        <div className="navbar-mobile-menu relative hidden">
          <nav className="fixed w-40 top-0 left-0 bottom-0 flex flex-col bg-gray-100 text-slate-900 antialiased overflow-y-auto">
      ...
      <nav className="md:block hidden min-h-screen w-40 flex-col flex-auto flex-shrink-0 antialiased bg-gray-100 text-slate-900">
